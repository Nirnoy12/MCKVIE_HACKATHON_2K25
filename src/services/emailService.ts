...
export const sendRegistrationEmail = async (registrationData: any, teamId: string): Promise<boolean> => {
  ...
  const templateParams = {
    ...
    teamLeaderInstitution: registrationData.teamLeaderInstitution || "",
    teammateName: registrationData.teammateName || "",
    teammateEmail: registrationData.teammateEmail || "",
    teammatePhone: registrationData.teammatePhone || "",
    teammateInstitution: registrationData.teammateInstitution || "",
